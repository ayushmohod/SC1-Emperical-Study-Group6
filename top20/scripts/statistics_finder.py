...
if __name__ == '__main__':
    code_lines, comment_lines, comment_ratio, total_lines = analyze_directory('./top20sol')
    # print(code_lines)#, comment_lines, comment_ratio, total_lines)
    ...
    code_lines_median = statistics.median(code_lines)
    ...
    comment_lines_median = statistics.median(comment_lines)
    ...
    total_lines_median = statistics.median(total_lines)
    ...
    comment_ratio_median = statistics.median(comment_ratio)
    ...
    print(f'Code lines: average={code_lines_avg}, variance={code_lines_var}, '
          f'standard deviation={code_lines_std},median={code_lines_median},  min={code_lines_min}, max={code_lines_max}')
    
    print(f'Total lines: average={total_lines_avg}, variance={total_lines_var}, '
          f'standard deviation={total_lines_std},median={total_lines_median} min={total_lines_min}, max={total_lines_max}')
    
    print(f'Comment lines: average={comment_lines_avg}, variance={comment_lines_var}, '
          f'standard deviation={comment_lines_std},median={comment_lines_median} min={comment_lines_min}, max={comment_lines_max}')
    
    print(f'Comment Ratio: average={comment_ratio_avg}, variance={comment_ratio_var}, '
          f'standard deviation={comment_ratio_std},median ={comment_ratio_median}, min={comment_ratio_min}, max={comment_ratio_max}')
    

    # print(f'Comment lines: average={comment_lines_avg}, variance={comment_lines_var}, '
    #       f'st
if __name__ == '__main__':
    analyze_directory('./top20sol')